...
import com.jsmosce.activity.HistoryCandidatesDetailsActivity;
 ...
 */
//考試項目
public class CandidatesHistoryListAdapter extends RecyclerView.Adapter<CandidatesHistoryListAdapter.MyViewHolder> implements View.OnClickListener, RecycleItemTouchHelper.ItemTouchHelperCallback {
    ...
    public CandidatesHistoryListAdapter(Context context) {
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.itemScoreEv.setText(mDatas.get(position).getState());
        holder.itemScoreEv.setText(mDatas.get(position).getState());
    ...
    public void onClick(final View v) {
        ...
        switch (v.getId()) {
            case R.id.card_view:
                Intent intent = new Intent(mContext, HistoryCandidatesDetailsActivity.class);
