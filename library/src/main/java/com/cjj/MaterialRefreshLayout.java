...
public class MaterialRefreshLayout extends FrameLayout {
    ...
    private final static int hIGHER_HEAD_HEIGHT = 50;
    private static int DEFAULT_PROGRESS_SIZE = 40;
    private final static int BIG_PROGRESS_SIZE = 40;
    ...
    private void init(Context context, AttributeSet attrs, int defstyleAttr) {
        ...
        if ((dm.widthPixels * 0.04) > 40){
            DEFAULT_PROGRESS_SIZE = (int) (dm.widthPixels * 0.04);
        }
